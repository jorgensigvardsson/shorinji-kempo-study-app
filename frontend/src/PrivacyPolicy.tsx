...
const PrivacyPolicy = () => {
  ...
  return (
    <div>
      ...
      <p>
        {translator.translate("Appen kräver ett konto, och kontot hör till en gren. Dina studiedata sparas på din enhet och synkas med vår server så att du kommer åt dem från alla dina enheter.")}
      </p>
      <p>
      ...
      <p>
        {translator.translate("När du ansöker om medlemskap i en gren sparar vi din e-postadress, ditt namn, vilken gren du ansöker till och det meddelande du själv skriver. Grenens administratörer får se uppgifterna för att kunna ta ställning till din ansökan.")}
      </p>
      <ul>
      ...
      <ul>
        ...
        <li>{translator.translate("Vilken gren du tillhör, och en eventuell ansökan om att byta gren.")}</li>
      ...
      <p>
        {translator.translate("Administratörer för din gren, för ditt förbund och för organisationen som helhet kan se ditt namn, din e-postadress och vilket inloggningssätt du använder. Det är vad som krävs för att kunna sköta medlemskapet. En administratör för en annan gren ser dig inte alls.")}
      </p>
