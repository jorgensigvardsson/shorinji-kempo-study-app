...
export const CHANGELOG: ChangelogEntry[] = [
  ...
  },
  {
    ...
    changes: [
      ...
      {
        emoji: "✨",
        sv: "Flashkorten har fått en lugnare och tydligare design. Onödiga etiketter och färgade knappar är borta, texten är lättare att läsa och du sveper vänster för att öva igen eller höger när du kan kortet. Svepningen är nu också stabilare, och nästa kort visas alltid med framsidan först.",
        en: "Flashcards now have a calmer, clearer design. Unnecessary labels and coloured buttons are gone, the text is easier to read, and you swipe left to practise again or right when you know the card. Swiping is now more reliable, and the next card always appears front first.",
        tr: "Bilgi kartları artık daha sade ve anlaşılır bir tasarıma sahip. Gereksiz etiketler ve renkli düğmeler kaldırıldı, metin daha kolay okunuyor; tekrar çalışmak için sola, kartı biliyorsanız sağa kaydırabilirsiniz. Kaydırma artık daha güvenilir ve sonraki kart her zaman önce ön yüzüyle gösteriliyor.",
        ja: "フラッシュカードを、より落ち着いて分かりやすいデザインに整えました。不要な表示や色付きボタンを減らして文字を読みやすくし、もう一度練習する場合は左へ、できる場合は右へスワイプできます。スワイプの動作も安定し、次のカードは必ず表面から表示されます。",
      },
    ],
  },
  {
